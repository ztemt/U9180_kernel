...
static void mdss_dsi_panel_bklt_dcs(struct mdss_dsi_ctrl_pdata *ctrl, int level)
{
	...
	if (ctrl && ctrl->panel_name 
		&& !strcmp(ctrl->panel_name, "cs nt35592 720p video mode dsi panel")) {
		if (led_pwm1[1] <= 0) led_pwm1[1] = 0;
		else if (led_pwm1[1] <= 10) led_pwm1[1] = 5;
		else if (led_pwm1[1] <= 20) led_pwm1[1] = 5+(led_pwm1[1]-10)*(10-5)/(20-10);
		else if (led_pwm1[1] <= 60) led_pwm1[1] = 10+(led_pwm1[1]-20)*(30-10)/(60-20);
		else if (led_pwm1[1] <= 90) led_pwm1[1] = 30+(led_pwm1[1]-60)*(40-30)/(90-60);
		else if (led_pwm1[1] <= 127) led_pwm1[1] = 40+(led_pwm1[1]-90)*(55-40)/(127-90);
		else if (led_pwm1[1] <= 147) led_pwm1[1] = 55+(led_pwm1[1]-127)*(60-55)/(147-127);
		else if (led_pwm1[1] <= 160) led_pwm1[1] = 60+(led_pwm1[1]-147)*(70-60)/(160-147);
		else if (led_pwm1[1] <= 180) led_pwm1[1] = 70+(led_pwm1[1]-160)*(90-70)/(180-160);
		else if (led_pwm1[1] <= 200) led_pwm1[1] = 90+(led_pwm1[1]-180)*(108-90)/(200-180);
		else if (led_pwm1[1] <= 210) led_pwm1[1] = 108+(led_pwm1[1]-200)*(180-108)/(210-200);
		else if (led_pwm1[1] <= 220) led_pwm1[1] = 180+(led_pwm1[1]-210)*(210-180)/(220-210);
		else if (led_pwm1[1] <= 255) led_pwm1[1] = 210+(led_pwm1[1]-220)*(215-210)/(255-220);
		else led_pwm1[1] = 215;
		pr_err("%s: level=%d. after\n", __func__, led_pwm1[1]);
	}
#endif
#endif
    ...
    mdelay(PW_ON_AVDD_NEG_SLEEP);
		...
		for (i = 0; i < pdata->panel_info.rst_seq_len; ++i) {
			...
			if (pdata->panel_info.rst_seq[++i])			
				...
				udelay(pdata->panel_info.rst_seq[i]);
#else
